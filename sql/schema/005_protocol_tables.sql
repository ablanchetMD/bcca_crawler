...
CREATE TABLE treatment_dose_modifications (
  protocol_treatment_id UUID NOT NULL REFERENCES protocol_treatment(id) ON DELETE CASCADE,
  treatment_modification_id UUID NOT NULL REFERENCES treatment_modifications(id) ON DELETE CASCADE,
  PRIMARY KEY (protocol_treatment_id, treatment_modification_id)
);

CREATE TABLE treatment_toxicity_modifications (
  protocol_treatment_id UUID NOT NULL REFERENCES protocol_treatment(id) ON DELETE CASCADE,
  toxicity_modification_id UUID NOT NULL REFERENCES toxicity_modifications(id) ON DELETE CASCADE,
  PRIMARY KEY (protocol_treatment_id, toxicity_modification_id)
);
...
DROP TABLE treatment_dose_modifications;
DROP TABLE treatment_toxicity_modifications;
